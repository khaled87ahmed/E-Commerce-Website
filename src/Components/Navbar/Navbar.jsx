...
import { fillCartOwner, fillCartProducts, fillNumOfCartItems, fillTotalCartPrice } from '../Redux/CartSlice'
  ...
  return (
    <nav className="navbar navbar-expand-lg bg-body-tertiary bg-opacity-50">
      <div className="container ">
        ...
        <Link className="navbar-brand" to="/"><img src={logoNav}></img></Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {location.pathname != '/login' && location.pathname != '/register' && location.pathname != '/resetcode' && location.pathname != '/resetpasswordfromout' ? <>
            ...
            <ul className="navbar-nav  me-auto ">
              ...
              <li className="nav-item active fitWidth">
                <Link id='products' className="nav-link" to="/products">Products</Link>
                <div id='line' className='line rounded-pill'></div>
              </li>

              <li className="nav-item active fitWidth">
                <Link id='categories' className="nav-link" to="/categories">Categories</Link>
                <div id='line' className='line rounded-pill'></div>
              </li>

              <li className="nav-item active fitWidth">
                <Link id='brands' className="nav-link" to="/brands">Brands</Link>
                <div id='line' className='line rounded-pill'></div>
              </li>
          ...
          <ul className="navbar-nav  ms-md-auto mb-2 ">
            ...
            <li className="nav-item mt-sm-2 mt-lg-4 me-2 d-flex">
              ...
              {location.pathname != '/login' && location.pathname != '/register' && location.pathname != '/resetcode' && location.pathname != '/resetpasswordfromout' ?
              <Link id='cart' className="nav-link position-relative mx-2 p-0" to="/cart" >
                <div className="fa-solid fa-cart-shopping fs-3 text-primary  position-relative  curserPointer "></div>
                <div className=' fitWidth position-absolute iconCounter rounded-circle d-flex justify-content-center align-items-center bgmainColor fw-bolder'>{counter}</div>
              </Link>
            : null}
            ...
            {location.pathname == '/login' || location.pathname == '/register' || location.pathname == '/resetcode' || location.pathname == '/resetpasswordfromout' ? <>
              ...
              <li className="me-2 mt-3">
                <Link className="btn btn-success" aria-current="page" to="/login">Sign in</Link>
              </li>
